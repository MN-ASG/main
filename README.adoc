...
We believe that there is clearly a new emerging model of information technology delivery. See our https://github.com/MN-ASG/main/blob/master/mn-asg-premises.adoc[Premises].
